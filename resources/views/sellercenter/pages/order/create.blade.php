...
<section class="page">
    ...
    <div class="page-toolbar">
        ...
        <div class="actions">
            <a href="{{ route('seller.orders.index') }}" class="action btn btn-primary">Orders</a>
        </div>
    </div>
    <div class="page-content">
        <form action="{{ route('seller.orders.manual.store') }}", method="POST">
            @csrf
                        ...
                        <div class="flex justify-end">
                            ...
                            <div class="bg-gray-300 p-2 rounded-b w-64 mt-3">
                                <div class="flex items-center justify-between text-gray-700">
                                    ...
                                    <span>Tk
                                        <input readonly id="delivery-charge-label" name="delivery_charge" type="number"
                                        class="text-lg font-medium ml-1 w-20 h-8" value="50">
                                    </span>
                                </div>
                            </div>
                        </div>
