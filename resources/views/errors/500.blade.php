...
<section class="">
    <div class="container page-section page-top-gap">
        <div class="card w-full md:w-full lg:w-[512px] mx-auto text-center py-16 rounded-lg border shadow-sm">
            <h1 class="text-4xl sm:text-4xl md:text-6xl lg:text-9xl font-bold text-primary">5<span class="text-secondary">00</span></h1>
            <div class="mt-2 text-base sm:text-base lg:text-xl">Internal Server Error.</div>
            <div class="">
