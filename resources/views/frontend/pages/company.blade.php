    ...
    <section class="page-section page-top-gap">
        <div class="container">
            ...
            <div class="grid grid-cols-4 gap-8">
                <div class="col-span-1 hidden sm:hidden lg:block">
                    <div class="filter-card">
                        <div class="title-wrapper">
                            <button id="filter-product" onclick="toggleFilter()" class="block sm:block lg:hidden bg-gray-200 border border-gray-300 h-8 w-8 mr-3 rounded">
                ...
                {{-- Filter Column --}}
                <div id="filter-category" style="display: block" class="col-span-4 sm:col-span-4 lg:col-span-1 hidden sm:hidden lg:block">
                    <div class="filter-card">
                        @if (count($categories))
...
@once
    ...
    <script>
        ...
        var route     = "{{ route('companies.show',[$slug]) }}?page={{ $products->currentPage() }}";
        ...
        function toggleFilter() {
            ...
            if(filterCategory.style.display == "none") { // if is menuBox displayed, hide it
    ...
    <script>
        var onScrollProductRoute = "{{ route('companies.show', [$slug, 'true']) }}";
