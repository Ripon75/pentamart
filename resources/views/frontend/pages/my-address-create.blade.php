                ...
                <div class="card p-4 w-full mx-auto sm:w-full md:w-full lg:w-1/2 xl:w-1/2 2xl:w-1/2">
                    ...
                    <form action="{{ route('my.address') }}" method="POST">
                        ...
                        <div class="form-item">
                            ...
                            <select class="form-input select-2-areas" name="district_id">
                                <option value="">Select</option>
                        ...
                        <div class="form-item">
                            ...
                            <input class="form-input" type="text" name="thana" placeholder="Write your thana"/>
                            <span class="text-red-500 text-xs">
                        ...
                        <div class="form-item">
                            ...
                            <textarea class="form-input" name="address" placeholder="Write your address"></textarea>
                            <span class="text-red-500 text-xs">
