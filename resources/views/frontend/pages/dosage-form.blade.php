        ...
        <div class="container">
            <nav class="breadcrumb-wrapper mb-4">
                <ol class="list-reset">
                    ...
                    <li class="last-item">Dosage Forms</li>
                </ol>
            </nav>
                ...
                <div class="col-span-4 sm:col-span-4 md:col-span-1">
                    <div class="filter-card">
                        <div class="title-wrapper">
                            <h1 class="title">Dosage Forms</h1>
                        </div>
                    </div>
                </div>
...
@once
    ...
    <script>
        ...
        var route     = "{{ route('dosage-forms.show', [$slug]) }}?page={{ $products->currentPage() }}";
    ...
    <script>
        var onScrollProductRoute = "{{ route('dosage-forms.show', [$slug, 'true']) }}";
