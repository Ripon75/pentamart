                ...
                <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <div class="bg-white relative flex flex-wrap py-6 rounded shadow-lg">
                        <div class="lg:w-1/2 px-6">
                            ...
                            <p class="mt-1">J K Tower, 31, Segun Bagicha, Ramna, Dhaka-1000, Bangladesh.</p>
                        </div>
                        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <a class="text-indigo-500 leading-relaxed">contact@medicart.health</a>
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                            <div class="leading-relaxed">
                                <span><a href="tel:+8809609080706">+8809609080706</a></span>,
                                <span><a href="tel:+8801322800327">+8801322800327</a></span>,
                                <span><a href="tel:+8801322800328">+8801322800328</a></span>
