<div>
   <div class="card border py-2 flex flex-col space-y-2 shadow-lg sm:shadow-lg md:shadow-lg lg:shadow-none xl:shadow-none 2xl:shadow-none">
        <a href="{{ route('my.dashboard') }}" class="{{ Route::currentRouteName() == 'my.dashboard' ? 'bg-primary-lightest' : '' }} py-1 sm:py-1 md:py-2 px-4 hover:bg-primary-lightest transition duration-300 flex items-center space-x-4">
            <span class="w-8 h-8 flex items-center justify-center border border-gray-300 rounded text-primary"><i class="fa-solid fa-chart-line"></i></span>
        ...
        <a href="{{ route('my.password') }}" class="{{ Route::currentRouteName() == 'my.password' ? 'bg-primary-lightest' : '' }} py-1 sm:py-1 md:py-2 px-4 hover:bg-primary-lightest transition duration-300 flex items-center space-x-4">
            <span class="w-8 h-8 flex items-center justify-center border border-gray-300 rounded text-primary"><i class="fa-solid fa-lock"></i></span><span class="font-medium text-primary text-sm sm:text-sm md:text-base">Password</span>
        </a>
    </div>
</div>
