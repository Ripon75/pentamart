...
<div class="px-8 py-4">
    <div class="py-4 flex items-center justify-between">
        <h3 class="font-bold text-lg">All medical device banners</h3>
        <a href="{{ route('admin.medical.device.banners.create') }}" class="btn btn-primary">Create</a>
    </div>
        ...
        <table class="table w-full">
            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td>{{ $data->bg_color }}</td>
                    <td class="text-center">
                        <a class="btn btn-success btn-sm" href="{{ route('admin.medical.device.banners.edit', $data->id) }}">Edit</a>
