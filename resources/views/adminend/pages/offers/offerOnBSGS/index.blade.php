...
@section('title', 'Offers BSGS')
@section('content')

<div class="page">
    <div class="page-toolbar">
        <h6 class="title">All Offers BSGS</h6>
        <div class="actions">
            <a href="{{ route('admin.offers.bsgs.create') }}" class="action btn btn-primary">Create</a>
        </div>
    </div>
            ...
            <table class="table w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->end_date }}</td>
                        <td class="text-center">
                            <a class="btn btn-success btn-sm" href="{{ route('admin.offers.bsgs.edit', $data->id) }}">Edit</a>
                            <a class="btn btn-primary btn-sm" href="{{ route('admin.offers.bsgs.show', $data->id) }}">Show</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
