...
@section('title', 'Offer Quantity Edit')
@section('content')

<div class="page">
    <div class="page-toolbar">
        <h6 class="title">Offers Quantity Edit</h6>
        <div class="actions">
    ...
    <div class="page-content">
        <div class="container">
            <form action="{{ route('admin.offers.quantity.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="card shadow body p-4 col-span-8 mt-4">
                        ...
                        <table class="table-auto w-full">
                            ...
                            <tbody class="items-table-body">
                                @foreach ($data->productsQty as $product)
                                <tr>
                                    ...
                                    <td class="border p-2"> 
                                        <input type="number" value="{{ $product->pivot->quantity }}" name="items[{{ $product->id }}][quantity]"
...
@push('scripts')
    ...
    // Calculate discout amount from discount percent
    ...
    function renderSelectedProduct() {
        ...
        <tr>
            ...
            <td class="border p-2 text-right">
                <input type="number" value="${productQty}" name="items[${ productId }][quantity]" 
                class="border-gray-300 focus:ring-0 focus:outline-none text-center w-20 rounded"/>
            </td>
            <td class="border p-2 text-right">
                <span>Tk</span>
