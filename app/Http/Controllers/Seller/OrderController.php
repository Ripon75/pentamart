...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orderObj = new Order();
        $orderObj = $orderObj->with(['status'])->where('created_by', $authID);
        ...
        return view('sellercenter.pages.order.index', [
            'result'      => $result,
            'areas'       => $areas,
            'dGateways'   => $dGateways,
            'pGateways'   => $pGateways,
    ...
    public function manualCreate(Request $request)
    {
        ...
        return view('sellercenter.pages.order.create', [
            'areas'             => $areas,
    ...
    public function manualStore(Request $request)
    {
        ...
        if ($res) {
            ...
            // Update order total_items_discount, order_payable_value and coupon_value
    ...
    public function edit(Request $request, $id)
    {
        ...
        $order = Order::with(['items' => function($query) {
            $query->withTrashed();
        }])->where('created_by', $authID)->find($id);
        ...
        return view('sellercenter.pages.order.edit', [
            'order'             => $order,
            'areas'             => $areas,
            'deliveryGateways'  => $deliveryGateways,
            'paymentGateways'   => $paymentGateways,
    ...
    public function update(Request $request, $id)
    {
        ...
        $authID = Auth::id();
        $order = Order::where('created_by', $authID)->find($id);
    ...
    public function show($id)
    {
        ...
        $order = Order::with(['items' => function($query) {
            $query->withTrashed();
        }, 'status'])->where('created_by', $authID)->find($id);

        if (!$order) {
            abort(404);
        }

        return view('sellercenter.pages.order.show', [
            'order'    => $order,
            'currency' => $this->currency
        ]);
    }
    ...
    public function invoice($id)
    {
        ...
        return view('sellercenter.pages.order.invoice', [
            'order' => $order
        ]);
    }
    ...
    public function multipleInvoice(Request $request)
    {
        ...
        $orders = Order::with(['items' => function($query) {
            $query->withTrashed();
        }])->where('created_by', $authID)->whereBetween('ordered_at', [$startDate, $endDate])->get();

        return view('sellercenter.pages.order.multiple-invoice', [
            'orders' => $orders
        ]);
    }
    ...
    public function shippingLabel($id)
    {
        ...
        return view('sellercenter.pages.order.shipping-label', [
            'order' => $order
        ]);
    }
    ...
    public function purchaseOrder($id)
    {
        ...
        return view('sellercenter.pages.order.purchase-order', [
            'order' => $order
        ]);
    }
    ...
    public function orderItemRemove(Request $request)
    {
        ...
        $order = Order::where('created_by', $authID)->find($orderRequstId);
    ...
    public function makePaid(Request $request)
    {
        ...
        Order::whereIn('id', $orderID)->where('created_by', $authID)->update(['is_paid' => 1]);
    ...
    public function prescriptionShow($id)
    {
        ...
        return view('sellercenter.pages.prescription.show', [
    ...
    public function sendOrderMedipos(Request $request)
    {
        ...
        $order = Order::with(['items' => function($query) {
            $query->withTrashed();
        }])->where('created_by', $authID)->find($orderId);
    ...
    public function statusUpdate(Request $request)
    {
        ...
        $order = Order::where('created_by', $authID)->find($orderId);
        if ($order) {
    ...
    {
        $authID = Auth::id();
        $order = Order::with(['transaction'])->where('created_by', $authID)->find($orderId);
        ...
        if ($paymentGateway === 'bkash') {
            return view('sellercenter.pages.order.payment-refund', [
                'order' => $order
            ]);
        }
    }
    ...
    {
        return view('sellercenter.pages.order.onclogy-bulk-order');
    }
    ...
    {
        return view('sellercenter.pages.order.upload-prescription', [
            'orderId' => $id
        ]);
    }
    ...
    public function UploadPrescriptionStore(Request $request, $id)
    {
        ...
        $authID        = Auth::id();
        $orderObj = Order::where('created_by', $authID)->find($id);
        if (!$orderObj) {
            abort(404);
        }
